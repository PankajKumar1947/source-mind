...
The `Image` component supports responsive images by default because it's built on top of the Next.js `Image` component. Check the [Next.js documentation](https://nextjs.org/docs/app/api-reference/components/image#responsive-images) for more details.
...
- A unique value to identify and prevent replays. Typically a UUID (e.g., version 4). Example: `token: "unique_upload_token"`
  ...
  Check the [signature generation](#generating-authentication-parameters) section for more details on how to generate this value.
...
export default function UnsupportedTransformationExample() {
  return (
    <ImageKitProvider urlEndpoint="https://ik.imagekit.io/your_imagekit_id">
      <Image
        src="/photo.jpg"
...
- Controls how the layer blends with the base image or underlying content. 
  ...
  - Supported values: `multiply`, `displace`, `cutout`, `cutter`, Check [reference](/add-overlays-on-images#layer-modes)
